...
\centering
\begin{tikzpicture}
	\begin{axis}[xlabel=n, ylabel=tempo (s), legend columns=5, cycle list name=black white]
	...
	\end{axis}
\end{tikzpicture}
\caption{Tempo de execução para match de $a^n$ contra $a*$}
...
\subsection{Provando pertinência em NP-completo}

Dado que 


\subsection{MATCH em NP}
