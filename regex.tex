...
Uma operação importante em linguagens é o fecho Kleene ($L^*$), que pode ser definido recursivamente.
...
\end{equation*}
\begin{equation*}
	L^i = \{w_1w_2 | w_1 \in L^{i-1}, w_2 \in L\}
\end{equation*}
\begin{equation*}
...
Uma gramática é formada por uma tupla $(N, \Sigma, P, S)$. Onde:
