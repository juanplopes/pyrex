...
\data{5}{Agosto}{2013} % {dia}{mes}{ano}
...
\begin{folhadeaprovacao}
  \assinatura{Prof. Fabiano de Souza Oliveira\\ Professor Adjunto IME/UERJ}
  \assinatura{Prof. Luérbio Faria\\ Professor Associado IME/UERJ}
...
Cook também provou que o problema de satisfabilidade booleana ({\sc sat}) é NP-completo. Resultado parecido com o que Leonid Levin alcançou independentemente em 1973 \cite{bib:Levin73}. Hoje este resultado é conhecido como teorema de Cook--Levin. 
...
\lstinputlisting[caption={Código-fonte da biblioteca PyRex},label=lst:fill_appendice]{../pyrex.py}

\postextualchapter{Código-fonte do Visualizador}\label{app:view_source}

\lstinputlisting[caption={Código-fonte do Visualizador},label=lst:view_appendice]{../view.py}
